...
clear;clc;
addpath(genpath(pwd));
load train_x_feature_200_200;

inputSize = 30; % Size of input vector (MNIST images are 28x28)
...
% images = loadMNISTImages('C:\data\train-images-idx3-ubyte');
%labels = loadMNISTLabels('train-labels-idx1-ubyte');
% labels = loadMNISTLabels('C:\data\train-labels-idx1-ubyte');

load 'mnist_uint8_new_train';
labels(labels==0) = 10; % Remap 0 to 10
%load 'train_x_feature_35_100';
