...
figure
subplot(2,3,4)
plot(a(2:max(a)),cost_blind(1,a(2:max(a)))+test_total_cost(a(2:max(a))),'-bx')
hold on
plot(a(2:max(a)),this_loop_cost(1+3,a(2:max(a)))+test_total_cost(a(2:max(a))),'-r+')
...
%%
subplot(2,3,1)
plot(a(2:max(a)),cost_blind(1,a(2:max(a))),'-bx')
hold on
plot(a(2:max(a)),this_loop_cost(1+3,a(2:max(a))),'-r+')
legend('Two-way Decision','Three-way Decision')
title('2DPCA  granulation','FontSize',10)
