...
%% recon figure data
 recon_dim1=[1 2 3 4 6 8 10 12 14 16 18 20 24 28 43]; %number of dimensionality 
 recon_dim2=[1 4 7 10 13 16 19 22 25 28 31 34 37 40 43];
 recon_dim3=[1 4 7 10 13 16 19 22 25 28 31 34 37 40 43];
...
%%
 ...
 imshow(im_all);
text_size=7;
text(376,72,'(a)','FontSize',text_size);
text(376,154,'(b)','FontSize',text_size);  
text(376,238,'(c)','FontSize',text_size);