...
M=10;NG=10;I=20; NI=NG;

%% get_train_test_data
max_dim=40;
loop_num=100;
loop_err=zeros(6,max_dim);
...
for i=1:M        
    ...
    for k=NG+1:kk
        ...
        Gtest_data_c=[Gtest_data_c this_data_c_rand(:,NG+1:kk)];
        Gtrain_label=[Gtrain_label class_i*ones(1,NG)];
        Gtest_label=[Gtest_label class_i*ones(1,kk-NG)];   
...
for i=1:I        
    ...
    for k=NI+1:kk
        ...
        Itest_data_c=[Itest_data_c this_data_c_rand(:,NI+1:kk)];
        Itrain_label=[Itrain_label class_i*ones(1,NI)];
        Itest_label=[Itest_label class_i*ones(1,kk-NI)];   
   ...
   Itest_label=zeros(1,I*(kk-NI));
   Gtest_label=ones(1,M*(kk-NG));
...
save('thir_PIE_TWD_vs_2D_02','this_loop_err_10','this_loop_err_01','this_loop_err_B0','this_loop_err_B1','this_loop_err','this_loop_cost','this_loop_P','this_loop_B','this_loop_N','max_dim','M','I','NG','NI','cost_seting')
