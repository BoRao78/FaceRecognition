...
hold on
plot(a,this_loop_err(1+3,a)/num_test,'-b*')
...
hold on
plot(a,this_loop_err(2+3,a)/num_test,'-b*')
legend('Two-way Decision','Three-way Decision')
...
%%
subplot(2,3,3)
plot(a,this_loop_err(3,a)/num_test,'-ro')
hold on
plot(a,this_loop_err(3+3,a)/num_test,'-b*')
legend('Two-way Decision','Three-way Decision')
...
%%
subplot(2,3,4)
plot(a(2:max(a)),this_loop_err(1,a(2:max(a)))/num_test,'-ro')
hold on
plot(a(2:max(a)),this_loop_err(1+3,a(2:max(a)))/num_test,'-b*')
legend('Two-way Decision','Three-way Decision')
